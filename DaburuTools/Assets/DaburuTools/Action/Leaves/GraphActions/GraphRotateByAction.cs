...
namespace DaburuTools
{
	namespace Action
	{
		public class GraphRotateByAction : Action
		{
			...
			public GraphRotateByAction(Transform _transform, Graph _graph)
			{
				mTransform = _transform;
				mGraph = _graph;
				SetupAction();
			}
			public GraphRotateByAction(Transform _transform, Graph _graph, Vector3 _desiredDelta, float _actionDuration)
			{
				mTransform = _transform;
				mGraph = _graph;
				SetupAction();
